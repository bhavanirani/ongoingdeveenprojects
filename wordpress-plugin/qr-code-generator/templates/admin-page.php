...
<div class="qcg-wrap">
    <div class="qcg-header">
        <h1><i class="fas fa-qrcode"></i> <?php esc_html_e('QR Code Generator', 'qr-code-generator'); ?></h1>
    ...
    <div class="qcg-body">
        ...
        <div class="alert alert-info">
            <strong><?php esc_html_e('Shortcode:', 'qr-code-generator'); ?></strong>
            <?php esc_html_e('Use', 'qr-code-generator'); ?> <code>[qr_code_generator]</code> <?php esc_html_e('on any page or post to display the QR Code Generator for your visitors.', 'qr-code-generator'); ?>
        </div>
    </div>
</div>
</div>
